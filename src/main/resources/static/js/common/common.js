...
$(function () {
    ...
    $(document).keydown(function (event) {
        ...
        var tagName = obj.documentElement.tagName;
        var type = (_a = obj.documentElement.attributes.getNamedItem("type")) === null || _a === void 0 ? void 0 : _a.value;
        var isReadOnly = (_b = obj.documentElement.attributes.getNamedItem("readOnly")) === null || _b === void 0 ? void 0 : _b.value;
        var isDisabled = (_c = obj.documentElement.attributes.getNamedItem("disabled")) === null || _c === void 0 ? void 0 : _c.value;
        // BackSpaceキーの制御
    ...
    $("form").on('submit', function (e) {
        ...
        $("select:disabled").each(function () {
            ...
            $("option", $this).each(function () {
                var $that = $(this);
                var isSelected = $that.val == selectedVal ? "true" : "";
