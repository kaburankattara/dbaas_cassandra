...
@Service
@Transactional
public class TableValidateBeanService {
    ...
    @Autowired
	public TableValidateBeanService(ServerService serverService, TableFindService tableFindService
	...
	public RegistTableResultDto validateFields(Table table) {
		return new RegistTableResultDto(table.validate(validator));
	}
