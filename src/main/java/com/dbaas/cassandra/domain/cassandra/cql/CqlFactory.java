...
public class CqlFactory {
	...
	public List<String> createAlterCqlForAddColumns(String keyspace, Table oldTable, Table newTable) {
		...
		for (Column column : newTable.getColumnList()) {
			...
			alterCqlList.add("ALTER TABLE \"" + keyspace + "\".\"" + newTable.getTableName() + "\" ADD (\""
